...
def train_model(model,
    ...
    if use_amp:
        ...
        runner = Runner(
            ...
            logger=logger,
            meta=meta)
    # an ugly workaround to make .log and .log.json filenames the same#这里开始训练
...
def train_model_1(model,
    ...
    # register hooks
    #runner.register_training_hooks(cfg.checkpoint_config, cfg.log_config,cfg.get('momentum_config', None))
