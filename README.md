TSMSPL model is an advanced neonatal pain recognition model, which can achieve high performance automated neonatal pain grading. Its deployment has the following requirements:
pytorch >= 1.10.0
mmaction 0.15.0
cuda >= 11.3
MSVC
